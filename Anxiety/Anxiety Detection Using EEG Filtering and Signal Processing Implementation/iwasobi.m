function [Wwasobi, Winit, ISR,signals]= iwasobi(x,AR_order,rmax,eps0)
%
...
time_start = cputime;
[Winit Ms conver] = uwajd(C0,20); %%% compute initial separation
...
for in = 1:num_of_iterations
    ...
    [Wwasobi,Ms]=wajd(C0,H,Wwasobi,5);
end
ISR=CRLB4(ARC)/N;
...
function [W_est Ms crit]=uwajd(M,maxnumiter,W_est0);
%
